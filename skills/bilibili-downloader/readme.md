...
### 下载视频
### 方式1，在编程工具，例如trae中输入提示词：
/bilibili-downloader 下载B站视频：https://www.bilibili.com/video/BV11r4y1x7Nu?t=2.4，cookies文件：D:\bili_down\cookies_www.bilibili.com.txt，下载目录：D:\bili_down\，视频需要支持在iphone播放

其中，视频地址可以从打开的B站的视频里，右键获取。
...
## 注意事项
1、如果使用了python虚拟环境，要在提示词里说明如何激活并使用虚拟环境
